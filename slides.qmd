...
format:
    revealjs: 
        ...
        toc: true
        preview-links: auto
        footer: "Archetypal Analysis: Characterizing data by \"extremes\""
---
...
ax.scatter(aa.archetypes_[:, 0], aa.archetypes_[:, 1], c='red', s=100)
plt.show()
```
...
- There is a Python package called `archetypes` that makes it easy to compute archetypes.
